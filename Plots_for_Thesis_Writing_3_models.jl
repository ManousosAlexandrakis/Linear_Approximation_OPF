...
alpha = 0.9,
markershape = :xcross,
strokealpha = 0  # Remove the black outline
)
...
savefig("C:\\Users\\alexa\\OneDrive\\Υπολογιστής\\Διπλωματική\\Διπλωματική Κώδικας\\Thesis_Writing\\Plots\\paper_Voltage_Magnitude_fixed_test.pdf")
...
max_delta = maximum([maximum(Y_D_ACOPF), maximum(Y_D_ACOPF_fixed),  maximum(Y_D_LINEAR),maximum(Y_D_LINEAR_fixed)])
min_delta = minimum([minimum(Y_D_ACOPF), minimum(Y_D_ACOPF_fixed), minimum(Y_D_LINEAR),minimum(Y_D_LINEAR_fixed)])
...
savefig("C:\\Users\\alexa\\OneDrive\\Υπολογιστής\\Διπλωματική\\Διπλωματική Κώδικας\\Thesis_Writing\\Plots\\paper_Voltage_Angle_fixed_test.pdf")
