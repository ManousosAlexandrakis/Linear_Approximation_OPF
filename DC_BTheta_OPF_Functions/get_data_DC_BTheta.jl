function load_power_system_data_dc_btheta_opf(filepath::String, filename::String; Ssystem=1)
    # First declare ALL global variables at the beginning
    global sgen_data, Edges, bus_data, load_data, slack_data, Upward_data, Downward_data
    ...
    global sgen_data = DataFrame(XLSX.gettable(xlsx["gen"]))
